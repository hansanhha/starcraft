...
import com.game.starcraft.core.resource.Consumable;
...
public class Probe extends Worker<Protoss> implements ShieldUnit {
    ...
    @ConstructorBinding
    public Probe(Hp hp, Armor armor, Damage damage, Shield shield, Mineral mineralCost, Gas gasCost, BuildTime buildTime, SupplyCost supplyCost, AttackSpeed attackSpeed, Coordinate coordinate, Townhall<Protoss> townhall) {
        super(hp, armor, damage, mineralCost, gasCost, buildTime, supplyCost, attackSpeed, coordinate, townhall);
        this.shield = shield;
    }
